...
wget -c https://github.kangle.icu/php/7.1/714/php-7.1.4.tar.bz2 -O php-7.1.4.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/7.1/714/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/7.1/714/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.kangle.icu/php/7.1/714/ioncube-$ZEND_ARCH-7.0.zip
...
#install apcu
wget -c https://github.kangle.icu/php/7.1/714/apcu-5.1.3.tgz
