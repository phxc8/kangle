...
wget -c https://github.kangle.icu/php/7.1/7130/php-7.1.30.tar.bz2 -O php-7.1.30.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/7.1/7130/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/7.1/7130/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.kangle.icu/php/7.1/7130/ioncube-$ZEND_ARCH-7.1.zip
...
#install apcu
wget -c https://github.kangle.icu/php/7.1/7130/apcu-5.1.17.tgz
...
wget -c https://github.kangle.icu/php/7.1/7130/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c https://github.kangle.icu/php/7.1/7130/php-memcached-3.1.3-dev.zip
...
cd ..
#install memcache
wget -c https://github.kangle.icu/php/7.1/7130/php-memcache-4.0.4-dev.zip
