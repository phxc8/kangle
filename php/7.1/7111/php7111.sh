...
wget -c https://github.kangle.icu/php/7.1/7111/php-7.1.11.tar.bz2 -O php-7.1.11.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/7.1/7111/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/7.1/7111/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.kangle.icu/php/7.1/7111/ioncube-$ZEND_ARCH-7.1.zip
...
#install apcu
wget -c https://github.kangle.icu/php/7.1/7111/apcu-5.1.3.tgz
...
wget -c https://github.kangle.icu/php/7.1/7111/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c https://github.kangle.icu/php/7.1/7111/php-memcached-php7.zip
