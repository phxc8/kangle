...
wget -c https://github.kangle.icu/php/5.4/5443/php-5.4.43.tar.bz2 -O php-5.4.43.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/5.4/5443/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/5.4/5443/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c https://github.kangle.icu/php/5.4/5443/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-$ZEND_ARCH.tar.gz
...
#install ioncube
wget -c https://github.kangle.icu/php/5.4/5443/ioncube-$ZEND_ARCH-5.4.zip
