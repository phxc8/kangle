...
wget -c https://github.kangle.icu/php/5.4/5445/php-5.4.45.tar.bz2 -O php-5.4.45.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/5.4/5445/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/5.4/5445/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c https://github.kangle.icu/php/5.4/5445/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-$ZEND_ARCH.tar.gz
...
cd ..
#install ioncube
wget -c https://github.kangle.icu/php/5.4/5445/ioncube-$ZEND_ARCH-5.4.zip
...
#install apcu
wget -c https://github.kangle.icu/php/5.4/5445/apcu-4.0.10.tgz
...
cd ..
#install memcache
wget -c https://github.kangle.icu/php/5.4/5445/memcache-3.0.8.tgz
