...
wget -c https://github.kangle.icu/php/5.5/5527/php-5.5.27.tar.bz2 -O php-5.5.27.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/5.5/5527/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/5.5/5527/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.kangle.icu/php/5.5/5527/ioncube-$ZEND_ARCH-5.5.zip
