...
wget -c https://github.kangle.icu/php/7.0/700/php-7.0.0.tar.bz2 -O php-7.0.0.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/7.0/700/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/7.0/700/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.kangle.icu/php/7.0/700/ioncube-$ZEND_ARCH-5.6.zip
