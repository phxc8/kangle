...
wget -c https://github.kangle.icu/php/7.0/703/php-7.0.3.tar.bz2 -O php-7.0.3.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/7.0/703/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/7.0/703/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.kangle.icu/php/7.0/703/ioncube-$ZEND_ARCH-5.6.zip
...
#install apcu
wget -c https://github.kangle.icu/php/7.0/703/apcu-5.1.3.tgz
