...
wget -c https://github.kangle.icu/php/source/5.5/php-5.5.38.tar.bz2 -O php-5.5.38.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/source/5.5/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/source/5.5/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c https://github.kangle.icu/php/source/5.5/zend-loader-php5.5-linux-$ZEND_ARCH.tar.gz
...
cd ..
#install ioncube
wget -c https://github.kangle.icu/php/source/5.5/ioncube-$ZEND_ARCH-5.5.zip
...
#install sg11
wget https://github.kangle.icu/php/sg11-$ZEND_ARCH/ixed.5.5.lin -O $PREFIX/ixed.5.5.lin
#install apcu
wget -c https://github.kangle.icu/php/source/5.5/apcu-4.0.10.tgz
...
cd ..
#install memcache
wget -c https://github.kangle.icu/php/source/5.5/memcache-3.0.8.tgz
