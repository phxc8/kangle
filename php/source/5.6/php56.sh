...
wget -c https://github.kangle.icu/php/source/5.6/php-5.6.40.tar.bz2 -O php-5.6.40.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/source/5.6/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/source/5.6/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c https://github.kangle.icu/php/source/5.6/zend-loader-php5.6-linux-$ZEND_ARCH.tar.gz
...
cd ..
#install ioncube
wget -c https://github.kangle.icu/php/source/5.6/ioncube-$ZEND_ARCH-5.6.zip
...
#install sg11
wget https://github.kangle.icu/php/sg11-$ZEND_ARCH/ixed.5.5.lin -O $PREFIX/ixed.5.6.lin
#install apcu
wget -c https://github.kangle.icu/php/source/5.6/apcu-4.0.10.tgz
...
cd ..
#install memcache
wget -c https://github.kangle.icu/php/source/5.6/memcache-3.0.8.tgz
