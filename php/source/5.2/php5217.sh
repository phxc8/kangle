...
wget -c https://github.kangle.icu/php/source/5.2/php-5.2.17.tar.bz2 -O php-5.2.17.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/source/5.2/config.xml -O $PREFIX/config.xml
fi
cd ..
#install zend
wget -c https://github.kangle.icu/php/source/5.2/zend-3.3.9-$ZEND_ARCH.tar.bz2
tar xjf zend-3.3.9-$ZEND_ARCH.tar.bz2
mv zend-3.3.9-$ZEND_ARCH $PREFIX/zend
wget -c https://github.kangle.icu/php/source/5.2/zend.ini -O $PREFIX/etc/php.d/zend.ini
#install ioncube
wget -c https://github.kangle.icu/php/source/5.2/ioncube-$ZEND_ARCH-5.2.zip
...
wget -c https://github.kangle.icu/php/source/5.2/ioncube.ini -O $PREFIX/etc/php.d/ioncube.ini
rm -rf $PREFIX/php-templete.ini
wget https://github.kangle.icu/php/source/5.2/php-templete.ini -O $PREFIX/php-templete.ini
#install sg11
wget https://github.kangle.icu/php/sg11-$ZEND_ARCH/ixed.5.2.lin -O $PREFIX/ixed.5.2.lin
#install apcu
wget -c https://github.kangle.icu/php/source/5.2/apcu-4.0.10.tgz
...
cd ..
#install memcache
wget -c https://github.kangle.icu/php/source/5.2/memcache-3.0.8.tgz
