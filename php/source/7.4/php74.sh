...
wget -c https://github.kangle.icu/php/source/7.4/libzip-1.3.2.tar.gz -O libzip-1.3.2.tar.gz
...
PREFIX="/vhs/kangle/ext/tpl_php74"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c https://github.kangle.icu/php/source/7.4/php-7.4.1.tar.bz2 -O php-7.4.1.tar.bz2
tar xjf php-7.4.1.tar.bz2
cd php-7.4.1
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/source/7.4/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/source/7.4/php-templete.ini -O $PREFIX/php-templete.ini
#install sg11
wget https://github.kangle.icu/php/sg11-$ZEND_ARCH/ixed.7.4.lin -O $PREFIX/ixed.7.4.lin
#install autoconf
wget -c https://github.kangle.icu/php/source/7.4/autoconf-2.69.tar.gz
...
cd ..
#install apcu
wget -c https://github.kangle.icu/php/source/7.4/apcu-5.1.17.tgz
tar zxf apcu-5.1.17.tgz
cd apcu-5.1.17
/vhs/kangle/ext/tpl_php74/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php74/bin/php-config
make -j 4
make install
cd ..
#install libmemcached
wget -c https://github.kangle.icu/php/source/7.4/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c https://github.kangle.icu/php/source/7.4/php-memcached-3.1.3-dev.zip
unzip -o php-memcached-3.1.3-dev.zip
cd php-memcached-3.1.3-dev
/vhs/kangle/ext/tpl_php74/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php74/bin/php-config --disable-memcached-sasl
make -j 4
make install
cd ..
#install memcache
wget -c https://github.kangle.icu/php/source/7.4/php-memcache-4.0.4-dev.zip
