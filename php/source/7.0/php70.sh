...
wget -c https://github.kangle.icu/php/source/7.0/php-7.0.33.tar.bz2 -O php-7.0.33.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/source/7.0/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/source/7.0/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.kangle.icu/php/source/7.0/ioncube-$ZEND_ARCH-7.0.zip
...
#install sg11
wget https://github.kangle.icu/php/sg11-$ZEND_ARCH/ixed.7.0.lin -O $PREFIX/ixed.7.0.lin
#install apcu
wget -c https://github.kangle.icu/php/source/7.0/apcu-5.1.15.tgz
...
wget -c https://github.kangle.icu/php/source/7.0/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c https://github.kangle.icu/php/source/7.0/php-memcached-3.1.0-dev.zip
