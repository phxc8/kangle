...
wget -c https://github.kangle.icu/php/source/7.3/php-7.3.13.tar.bz2 -O php-7.3.13.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/source/7.3/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/source/7.3/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.kangle.icu/php/source/7.3/ioncube-$ZEND_ARCH-7.3.zip
...
#install sg11
wget https://github.kangle.icu/php/sg11-$ZEND_ARCH/ixed.7.3.lin -O $PREFIX/ixed.7.3.lin
#install autoconf
wget -c https://github.kangle.icu/php/source/7.3/autoconf-2.69.tar.gz
...
cd ..
#install apcu
wget -c https://github.kangle.icu/php/source/7.3/apcu-5.1.17.tgz
...
wget -c https://github.kangle.icu/php/source/7.3/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c https://github.kangle.icu/php/source/7.3/php-memcached-3.1.3-dev.zip
...
cd ..
#install memcache
wget -c https://github.kangle.icu/php/source/7.3/php-memcache-4.0.4-dev.zip
