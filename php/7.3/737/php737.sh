...
wget -c https://github.kangle.icu/php/7.3/737/libzip-1.3.2.tar.gz -O libzip-1.3.2.tar.gz
...
wget -c https://github.kangle.icu/php/7.3/737/php-7.3.7.tar.bz2 -O php-7.3.7.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/7.3/737/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/7.3/737/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.kangle.icu/php/7.3/737/ioncube-$ZEND_ARCH-7.3.zip
...
#install autoconf
wget -c https://github.kangle.icu/php/7.3/737/autoconf-2.69.tar.gz
...
cd ..
#install apcu
wget -c https://github.kangle.icu/php/7.3/737/apcu-5.1.17.tgz
...
wget -c https://github.kangle.icu/php/7.3/737/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c https://github.kangle.icu/php/7.3/737/php-memcached-3.1.3-dev.zip
...
cd ..
#install memcache
wget -c https://github.kangle.icu/php/7.3/737/php-memcache-4.0.4-dev.zip
