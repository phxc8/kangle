...
wget -c https://github.kangle.icu/php/5.6/5640/php-5.6.40.tar.bz2 -O php-5.6.40.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/5.6/5640/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/5.6/5640/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c https://github.kangle.icu/php/5.6/5640/zend-loader-php5.6-linux-$ZEND_ARCH.tar.gz
...
cd ..
#install ioncube
wget -c https://github.kangle.icu/php/5.6/5640/ioncube-$ZEND_ARCH-5.6.zip
...
#install apcu
wget -c https://github.kangle.icu/php/5.6/5640/apcu-4.0.10.tgz
...
cd ..
#install memcache
wget -c https://github.kangle.icu/php/5.6/5640/memcache-3.0.8.tgz
