...
wget -c https://github.kangle.icu/php/5.6/5631/php-5.6.31.tar.bz2 -O php-5.6.31.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.kangle.icu/php/5.6/5631/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.kangle.icu/php/5.6/5631/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c https://github.kangle.icu/php/5.6/5631/zend-loader-php5.6-linux-$ZEND_ARCH.tar.gz
...
#install ioncube
wget -c https://github.kangle.icu/php/5.6/5631/ioncube-$ZEND_ARCH-5.6.zip
...
#install apcu
wget -c https://github.kangle.icu/php/5.6/5631/apcu-4.0.10.tgz
...
make install
#install memcache
wget -c https://github.kangle.icu/php/5.6/5631/memcache-3.0.8.tgz
